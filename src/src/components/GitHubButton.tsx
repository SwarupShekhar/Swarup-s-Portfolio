...
export default function GitHubButton() {
    return (
        ...
        >
            <button className="group w-12 hover:w-44 h-12 hover:bg-gray-800 relative bg-gray-900 rounded-xl text-neutral-50 duration-700 font-bold flex justify-start gap-2 items-center p-2 pr-6 overflow-hidden">
